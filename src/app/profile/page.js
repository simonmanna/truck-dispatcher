...
const Profile = () => {
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "mx-auto max-w-242.5" },
      React.createElement(Breadcrumb_1.default, { pageName: "Profile" }),
      React.createElement(
        "div",
        {
          className:
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                "absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4",
            },
            React.createElement(
              "label",
              {
                htmlFor: "cover",
                className:
                  "flex cursor-pointer items-center justify-center gap-2 rounded bg-primary px-2 py-1 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4",
              },
        ...
        React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "label",
                {
                  htmlFor: "profile",
                  className:
                    "absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2",
                },
                React.createElement(
                  "svg",
                  {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              {
                className:
                  "mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]",
              },
              React.createElement(
                "div",
                {
                  className:
                    "flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row",
                },
                React.createElement(
                  "span",
                ...
                React.createElement("span", { className: "text-sm" }, "Posts"),
              ),
              React.createElement(
                "div",
                {
              ...
              React.createElement(
                ...
                {
                  className:
                    "flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row",
                },
                React.createElement(
                  "span",
                  { className: "font-semibold text-black dark:text-white" },
            ...
            React.createElement(
              ...
              React.createElement(
                "h4",
                { className: "mb-3.5 font-medium text-black dark:text-white" },
                "Follow me on",
              ),
              React.createElement(
                "div",
