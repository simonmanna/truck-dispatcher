...
const Buttons = () => {
  return React.createElement(
    ...
    null,
    React.createElement(Breadcrumb_1.default, { pageName: "Buttons" }),
    React.createElement(
      "div",
      {
        className:
        ...
        React.createElement(
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-md bg-primary px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-full bg-primary px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-md border border-primary px-10 py-4 text-center font-medium text-primary hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
        ),
        React.createElement(
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center bg-meta-3 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-md bg-meta-3 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-full bg-meta-3 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-md border border-meta-3 px-10 py-4 text-center font-medium text-meta-3 hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
        ),
        React.createElement(
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center bg-black px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
          React.createElement(
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-full bg-black px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center rounded-md border border-black px-10 py-4 text-center font-medium text-black hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            "Button",
          ),
        ),
        ...
        React.createElement(
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 bg-primary px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 bg-meta-3 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 bg-black px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 border border-primary px-10 py-4 text-center font-medium text-primary hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
        ...
        React.createElement(
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 rounded-md bg-meta-3 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 rounded-md bg-black px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 rounded-md border border-primary px-10 py-4 text-center font-medium text-primary hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
        ...
        React.createElement(
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 rounded-full bg-primary px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 rounded-full bg-meta-3 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 rounded-full bg-black px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
          ...
          React.createElement(
            link_1.default,
            {
              href: "#",
              className:
                "inline-flex items-center justify-center gap-2.5 rounded-full border border-primary px-10 py-4 text-center font-medium text-primary hover:bg-opacity-90 lg:px-8 xl:px-10",
            },
            React.createElement(
              "span",
              null,
